<html>
    <head>
        ...
        <?php wp_head(); ?>
        <link rel="icon" href="<?php echo get_stylesheet_directory_uri();?>/images/favicon-logo.png" sizes="32x32">
        <script type="text/javascript" id="events-manager-js-extra">var EM = {};</script>
    </head>
    <body class="home page-template page-template-homepage page-template-homepage-php page page-id-20 theme-citygov is-eleslider woocommerce-js elementor-default elementor-kit-5974 elementor-page elementor-page-20 e--ua-blink e--ua-chrome e--ua-webkit" data-elementor-device-mode="desktop">
        ...
        <div id="header" class="tranz" itemscope="" itemtype="http://schema.org/WPHeader">
            <div class="container_head"> <a class="screen-reader-text ribbon skip-link" href="#content_start">Skip to
                ...
                <div id="titles" class="tranz2"> <a class="logo" href="#"> <img
                            class="tranz"
                            src="<?php echo get_stylesheet_directory_uri();?>/images/logo-mdv2.png"
                            alt="CityGov"> </a></div>
